...
Status: active
Scope: `MultiAgentExample`, repo-local handoff, project notes, external worker prompts, and session recall.
...
| Long-term strategy/rationale/decision | `notes/Projects/MultiAgentExample/` |
...
- `notes/Projects/MultiAgentExample/00_Index.md`
