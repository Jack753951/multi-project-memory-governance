# Active Strategy Queue — ExampleProject
...
Project-specific state belongs here, in `handoff/accepted_changes.md`, named handoff artifacts, or `notes/Projects/ExampleProject/`. Global durable memory should contain only compact pointers and user-wide preferences.
